        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled ">
                    <li><i class="fas fa-envelope"></i> <a href="mailto:info@example.com" class="footer-link">
                            info@example.com</a></li>
                    <li><i class="fas fa-phone"></i> <a href="tel:+911234567890" class="footer-link"> +91 12345
                            67890</a></li>
