        ...
        <div class="row">
            ...
            <div class="col-lg-6 mt-4 mt-lg-0">
                <div class="bg-img bg-img-lg margin-left-1-lg"
                    style="background:url('https://themexriver.com/wp/technox/wp-content/uploads/2025/06/c2-img-1.webp') center/cover no-repeat;">
                </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-lg-3" data-aos="flip-right" data-aos-delay="100">
                <div class="info-card  p-4 h-100">
                    ...
                    <p class="mb-0">Technox delivers smart, reliable IT solutions tailored to drive your business</p>
                </div>
            </div>
